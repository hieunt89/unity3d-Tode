...
public class MapConstructorWindow : EditorWindow {
	...
	[MenuItem("Window/Map Constructor &M")]
...
//		var pointSize = EditorGUILayout.Slider(pointSize, 0f, maxPointSize);
//		var baseColor = EditorGUILayout.ColorField(baseColor);
//		var pathColor = EditorGUILayout.ColorField(pathColor);
//		var wayPointColor = EditorGUILayout.ColorField(wayPointColor);
//		var towerPointColor = EditorGUILayout.ColorField(towerPointColor);
...
//			towerPointColor = towerPointColor;
...
//			mc.ApplyModifiedProperties();	// ????
	...
	private bool CheckFields () {
		...
		var initGoldInput = map.InitGold > 0;

		var initLifeInput = map.InitLife > 0;
		...
		return mapIdInput && initGoldInput && initLifeInput && pathInput && towerPointInput && waveInput;
